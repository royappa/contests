...
//for (int c = 0; c < 5; c++) printf("%d ", aranks[c]); printf("\n");
	...
	if ((ranks[0] == ranks[1]-1 && ranks[1] == ranks[2]-1 && ranks[2] == ranks[3]-1) ||
		(ranks[1] == ranks[2]-1 && ranks[2] == ranks[3]-1 && ranks[3] == ranks[4]-1) ||
		(aranks[0] == aranks[1]-1 && aranks[1] == aranks[2]-1 && aranks[2] == aranks[3]-1) ||
		(aranks[1] == aranks[2]-1 && aranks[2] == aranks[3]-1 && aranks[3] == aranks[4]-1)
	   )
	{
		return "straight";
	}
